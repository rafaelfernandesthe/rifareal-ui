  ...
  ngOnInit() {
    ...
    this.sub = this.route.params.subscribe(params => {
      ...
      this.rifaService.loadByCodigo(this.codigo).then( result => {
        ...
        this.qtdDisponivel = this.todosNumeros.filter(n => n.statusNum === 1).length;
        this.qtdReservado = this.todosNumeros.filter(n => n.statusNum === 2).length;
        this.qtdPago = this.todosNumeros.filter(n => n.statusNum === 3).length;
